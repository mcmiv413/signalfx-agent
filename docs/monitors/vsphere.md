...
monitor config option `extraGroups`:
 ...
 - `vsphere.cpu_used_percent` (*cumulative*)<br>    Time accounted to the virtual machine.
...
monitor config option `extraGroups`:
 ...
 - `vsphere.disk.number_write` (*cumulative*)<br>    Number of disk writes during the collection interval.
...
monitor config option `extraGroups`:
 - `vsphere.net.broadcast_rx` (*cumulative*)<br>    Number of broadcast packets received during the sampling interval.
 - `vsphere.net.broadcast_tx` (*cumulative*)<br>    Number of broadcast packets transmitted during the sampling interval.
 ...
 - `vsphere.net.dropped_rx` (*cumulative*)<br>    Number of received packets dropped during the collection interval.
 - `vsphere.net.dropped_tx` (*cumulative*)<br>    Number of transmitted packets dropped during the collection interval.
 - `vsphere.net.errors_rx` (*cumulative*)<br>    Number of packets with errors received during the sampling interval.
 - `vsphere.net.errors_tx` (*cumulative*)<br>    Number of packets with errors transmitted during the sampling interval.
 - `vsphere.net.multicast_rx` (*cumulative*)<br>    Number of multicast packets received during the sampling interval.
 - `vsphere.net.multicast_tx` (*cumulative*)<br>    Number of multicast packets transmitted during the sampling interval.
 - `vsphere.net.packets_rx` (*cumulative*)<br>    Number of packets received during the interval.
 - `vsphere.net.packets_tx` (*cumulative*)<br>    Number of packets transmitted during the interval.
 ...
 - `vsphere.net.unknown_protos` (*cumulative*)<br>    Number of frames with unknown protocol received during the sampling interval
...
monitor config option `extraGroups`:
 - `vsphere.power.energy_joules` (*cumulative*)<br>    Total energy used since last stats reset.
